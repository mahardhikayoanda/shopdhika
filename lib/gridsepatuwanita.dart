...
class _GridSepatuWanitaState extends State<GridSepatuWanita> {
  ...
  Future<void> getAllProducts() async {
    const String url = "https://backend-mobile.mazdick.biz.id/gridsepatuwanita.php";
    try {
...
class DetailSepatuWanita extends StatelessWidget {
  ...
  String getImageUrl(String? url) {
    ...
    if (url.startsWith('http')) return url;
    return "http://192.168.18.6/server_shopdhika/$url";
  }
        ...
        child: ElevatedButton(
          ...
          onPressed: () async {
            ...
            final res = await http.post(
              Uri.parse("https://backend-mobile.mazdick.biz.ida/cart.php"),
