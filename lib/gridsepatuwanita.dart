...
class GridSepatuWanita extends StatefulWidget {
  ...
  @override
  State<GridSepatuWanita> createState() => _GridBajuPriaState();
}

class _GridBajuPriaState extends State<GridSepatuWanita> {
  List<dynamic> products = [];
  bool isLoading = true;

  Future<void> getAllProducts() async {
    const String url = "https://10.0.3.2/server_shop_vanzi/gridsepatuwanita.php";
    try {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const Text("Sepatu Wanita", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
        leading: IconButton(
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => DetailSepatuWanita(item: item),
          ),
        );
      },
      child: Container(
