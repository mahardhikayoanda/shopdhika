...
class GridBajuWanita extends StatefulWidget {
  ...
  @override
  State<GridBajuWanita> createState() => _GridBajuPriaState();
}

class _GridBajuPriaState extends State<GridBajuWanita> {
  List<dynamic> products = [];
  bool isLoading = true;

  Future<void> getAllProducts() async {
    const String url = "https://10.0.3.2/server_shop_vanzi/gridbajuwanita.php";
    try {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const Text("Baju Wanita", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
        leading: IconButton(
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (_) => DetailBajuWanita(item: item),
          ),
        );
      },
      child: Container(
